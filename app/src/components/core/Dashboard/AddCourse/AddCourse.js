        ...
        <div className="add-course">
            ...
            <div className="add-course-instructions">
                ...
                <ul className="add-course-instructions-list">
                    ...
                    <li>Standard size for the course thumbnail is 1024x578.</li>
                    <li>Video section contains the course overview video.</li>
                    <li>
                        Course Builder is where you create & organise a course.
                    </li>
                    <li>
                    ...
                    <li>
                        Information from the Additional Data section shows up in
